...
const executionNumber = parseInt(process.argv[2]) || 0;
const browserType = executionNumber % 2 === 0 ? 'firefox' : 'chrome';
...
// if we do it will say You're all set!
  ...
  await page.screenshot({path: `failure${executionNumber}.png`})
} finally {
  await browser.close();
}
